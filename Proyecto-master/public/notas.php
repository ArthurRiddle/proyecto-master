...
<body>
					...
					<div class="container-fluid"> 
						...
						<div class="collapse navbar-collapse" id="ele">
							<ul class="navbar-nav me-auto">
								...
								<li class="nav-item">
									<a class="nav-link" href="gastos.php">Registrar Gastos</a>
								</li>
								<li class="nav-item">
            ...
            <div class="row text-center">
				<h2 class="text-justify">Registrar Notas</h2>	
			</div>
   <br><!-- <hr> -->

   <form action="validatenotas.php " method="post" accept-charset="utf-8"> 
<center><B>Nota: </B><br>
<textarea name="nota" style="width: 300px; height: 100px; 
background-color: white; color:Black;font-family: Comic Sans MS;"></textarea>
  <br><br>
